    ...
    <van-popup v-model="show"  position="bottom" :style="{ height: '50%' }" >
        <van-tabs>
            ...
            <van-tab title="标签2">
                ...
                <!-- <van-cell :title="title" is-link to="index" :value="ceshi"/> -->
                <!-- <van-cell center :value="ceshi"/> -->
                <!-- <van-stepper :value="value" theme="round" button-size="22" min="0" /> -->
                <span dot><van-icon  dot />111</span>
            </van-tab>
        </van-tabs>
    <van-popup v-model="showChild" position="bottom" :style="{ height: '40%', zIndex: 1000 }" >
        2222222
    </van-popup>
    <!-- <van-dialog v-model="showDialog" show-cancel-button title="标题">
        <img src="https://img.yzcdn.cn/vant/apple-3.jpg" :style="{width:'100px', height:'100px'}"/>
    </van-dialog> -->
    </van-popup>
</template>

<script>
import {Popup, Tab, Tabs, Dialog, RadioGroup, Radio, Cell, CellGroup, Stepper, Icon } from 'vant'
export default {
    name: 'myAddress',
    components: {
        vanPopup: Popup,
    ...
    data () {
        return {
            ...
            City: false,
            radioData: [
                {channelName: "应用宝", isChecked: true},
                {channelName: "华为游戏", isChecked: false}
            ],
            // v-for循环判断是否为当前
            selected: false,
            info: [
